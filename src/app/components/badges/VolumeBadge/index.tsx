...
interface VolumeBadgeState {
  showController?: boolean
}

class VolumeBadgeComponent extends React.Component<VolumeBadgeProps, VolumeBadgeState> {

  state: VolumeBadgeState = {};
...
// const mapStateToProps = (state: ReduxState, ownProps: Partial<VolumeBadgeProps>): Partial<VolumeBadgeProps> => ({
//   volume: 0
// });

// export const VolumeBadge = connect(mapStateToProps)(VolumeBadgeComponent);

export { VolumeBadgeComponent as VolumeBadge }